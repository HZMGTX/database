...
searchable alongside everything else in Vault **without touching it**.
...
that gains a table next month is picked up without a Vault release, and a
...
def connect(db: Database, source: "str | Path", *, dry_run: bool = False,
    ...
    """Ingest VYREX's database into Vault, read-only."""
