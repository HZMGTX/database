...
from db import SCHEMA_VERSION, __version__, dates, files, history, ids, model, search
        ...
        def do_search(request):
            ...
            try:
                ...
                raise ProblemError(400, "Bad query", str(exc),
                                   type_="https://hzdb.local/problem/bad-query")
            return Response(200, {
        ...
        def create_item(request):
            ...
            try:
                ...
                raise ProblemError(422, "Could not create that", str(exc),
                                   type_="https://hzdb.local/problem/validation")
        ...
        def patch_item(request, ref):
            ...
            if "if-match" not in request.headers:
                ...
                raise ProblemError(
                    ...
                    type_="https://hzdb.local/problem/if-match-required",
            ...
            try:
                ...
                raise ProblemError(
                    ...
                    type_="https://hzdb.local/problem/stale-write",
    ...
    def _guard(request: Request) -> None:
        ...
        if api.allowed_hosts and host not in api.allowed_hosts:
            raise ProblemError(
                ...
                type_="https://hzdb.local/problem/host-not-allowed")
    ...
    def application(environ, start_response):
        ...
        try:
            ...
            response = Response(500, {
                ...
                "status": 500,
                "detail": "The server logged the details. This is a bug in The database.",
