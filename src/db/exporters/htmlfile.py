"""A single HTML file that still works when The database is gone.
...
<footer>Exported from The database __VERSION__. This file needs nothing but a browser.</footer>
...
def export(db: Database, out: TextIO, *, query: Optional[str] = None,
           include_trashed: bool = False, title: str = "The database", **_: Any) -> int:
    records = []
